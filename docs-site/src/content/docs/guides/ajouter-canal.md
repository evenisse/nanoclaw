...
| **Signal** | `/add-signal` | `SIGNAL_ACCOUNT`, `SIGNAL_TCP_HOST`, `SIGNAL_TCP_PORT` | Nécessite signal-cli en daemon TCP |
...
| **DeltaChat** | `/add-deltachat` | `DC_EMAIL`, `DC_PASSWORD`, `DC_IMAP_HOST`, `DC_IMAP_PORT`, `DC_SMTP_HOST`, `DC_SMTP_PORT` | Messagerie chiffrée via email |
