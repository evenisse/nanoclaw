...
| `group` *(défaut)* | Lire et modifier son propre groupe (membres, destinations, sessions, config) — **ne peut pas** modifier les wirings, lire les autres groupes, accorder des rôles, ni changer son propre `cli_scope` |
